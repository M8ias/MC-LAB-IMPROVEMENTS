...
int fd_;
double servoOffsets[] = {-0.52f, 1.475f, -1.568f, -1.319f, -0.02f, 1.156f}; // The offset in the first element here corresponds to the offset of the servo with the id matching the first element of servoIds
